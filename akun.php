            ...
            <div class="modal-body">
              <form class="needs-validation" novalidate action="proses/input_akun.php" method="post">
                ...
                <div class="form-floating">
                  <input type="password" class="form-control" id="floatingPassword" placeholder="Password" readonly
      ...
      foreach ($result as $row) {
              ...
              <div class="modal-body">
                <form class="needs-validation" novalidate action="proses/input_akun.php" method="post">
                  <div class="row">
                    <div class="col-lg-6">
                      <div class="form-floating mb-3">
                        <input type="text" class="form-control" id="floatingInput" disabled placeholder="Nama kamu"
                    ...
                    <div class="col-lg-6">
                      <div class="form-floating mb-3">
                        <input type="email" class="form-control" id="floatingInput" placeholder="name@example.com"
                          disabled name="email" value="<?php echo $row['email'] ?>">
                        <label for="floatingInput">Email</label>
                      </div>
                    </div>
                  </div>
                  <div class="row">
                    <div class="col-lg-8">
                      <div class="form-floating mb-3">
                        <input type="NUMBER" class="form-control" id="floatingInput" placeholder="08xxx" name="nohp"
                          disabled value="<?php echo $row['nohp'] ?>">
                        <label for="floatingInput">No HP</label>
                      </div>
                    </div>
                    <div class="col-lg-4">
              ...
              <div class="modal-body">
                <form class="needs-validation" novalidate action="proses/edit_akun.php" method="post">
                  <div class="row">
                    ...
                    <div class="col-lg-6">
                      <div class="form-floating mb-3">
                        <input <?php echo ($row['email'] == $_SESSION['email_rm']) ? 'disabled' : '' ?> type="text"
                          class="form-control" id="floatingInput" placeholder="Nama kamu" name="nama"
                    ...
                    <div class="col-lg-6">
                      <div class="form-floating mb-3">
                        <input <?php echo ($row['email'] == $_SESSION['email_rm']) ? 'disabled' : '' ?> type="email"
                          class="form-control" id="floatingInput" placeholder="name@example.com" name="email"
                  ...
                  <div class="row">
                    <div class="col-lg-8">
                      <div class="form-floating mb-3">
                        <input <?php echo ($row['email'] == $_SESSION['email_rm']) ? 'disabled' : '' ?> type="NUMBER"
                          class="form-control" id="floatingInput" placeholder="08xxx" name="nohp"
                    ...
                    <div class="col-lg-4">
                      <div class="form-floating mb-3">
                        <select <?php echo ($row['email'] == $_SESSION['email_rm']) ? 'disabled' : '' ?> class="form-select"
                          aria-label="Default select example" name="level" id="" required>
                          <?php
                          $data = array("Admin", "Kasir", "Pelanggan");
                          foreach ($data as $key => $value) {
                            if ($row['level'] == $key + 1) {
        ...
        <div class="modal fade" id="ModalResetPassword<?php echo $row['id'] ?>" tabindex="-1"
          ...
          <div class="modal-dialog modal-xl modal-fullscreen-md-down">
            <div class="modal-content">
              <div class="modal-header">
                <h1 class="modal-title fs-5" id="exampleModalLabel">Reset Data Akun</h1>
                <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
              </div>
              <div class="modal-body">
                ...
                <tr>
                  ...
                  <td class="d-flex">
                    ...
                    <button class="btn btn-danger btn-sm me-1  " data-bs-toggle="modal"
                      data-bs-target="#ModalHapus<?php echo $row['id'] ?>"><i class="bi bi-trash3"></i></button>
